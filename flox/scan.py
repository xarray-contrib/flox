...
def groupby_scan(
    ...
    *by : ndarray or DaskArray
    ...
    from .aggregations import AGGREGATIONS, AlignedArrays, Scan, _atleast_1d
    from .core import (
...
def chunk_scan(inp: AlignedArrays, *, axis: int, agg: Scan, dtype=None, keepdims=None) -> ScanState:
    from .aggregations import AlignedArrays, ScanState, generic_aggregate
...
def grouped_reduce(inp: AlignedArrays, *, agg: Scan, axis: int, keepdims=None) -> ScanState:
    from .aggregations import AlignedArrays, ScanState
...
def _zip(group_idx: np.ndarray, array: np.ndarray) -> AlignedArrays:
    from .aggregations import AlignedArrays
